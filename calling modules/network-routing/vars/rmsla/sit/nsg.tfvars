# NSG details for sit spoke subscription
nsg_config = {
  nsg-snet-mhra-sit-uks-h1s01-waf = {
  ...
  nsg-snet-mhra-sit-uks-h1s01-presentation = {
    provider_alias      = "spoke1-sub"
    is_applicable       = true
    resource_group_name = "rg-mhra-sit-uks-network"
    tags = {
    ...
    security_rule = [
      {
        ...
        destination_address_prefix = "10.24.12.0/22"
      ...
      },
      {
        ...
        source_port_range          = "*"
        destination_port_range     = "443"
        source_address_prefix      = "10.24.10.0/24"
        destination_address_prefix = "10.24.12.0/22"
        description                = "Allow HTTPS inbound from WAF"
      },
      {
        name                       = "Allow_Inbound_snet-mhra-sit-uks-h1s01-testing"
        priority                   = 1100
        direction                  = "Inbound"
        access                     = "Allow"
        protocol                   = "*"
        source_port_range          = "*"
        destination_port_range     = "*"
        source_address_prefix      = "10.24.40.0/24"
        destination_address_prefix = "10.24.12.0/22"
        description                = "Allow inbound traffic from the Testing Subnet 10.24.40.0/24 snet-mhra-sit-uks-h1s01-testing"
      },
      {
        name                       = "Deny_Any_Inbound"
        priority                   = 4096
      ...
      },
      {
        ...
        source_address_prefix      = "10.24.12.0/22"
        destination_address_prefix = "*"
  ...
  nsg-snet-mhra-sit-uks-h1s01-app = {
    provider_alias      = "spoke1-sub"
    is_applicable       = true
    resource_group_name = "rg-mhra-sit-uks-network"
    tags = {
    ...
    security_rule = [
      {
        ...
        destination_port_range     = "22, 443, 3389"
        source_address_prefix      = "10.20.0.0/22,10.20.4.0/22,10.100.0.82,10.100.0.113"
        destination_address_prefix = "10.24.16.0/22"
        description                = "Allows access from on-premises VDI"
      },
      {
        name                       = "Allow_DCS_SIT"
        ...
        destination_address_prefix = "10.24.16.16"
        description                = ""
      },
      {
      ...
      },
      {
        ...
        source_port_range          = "*"
        destination_port_range     = "443"
        source_address_prefix      = "10.5.1.0/24,10.20.0.0/22,10.20.4.0/22,10.5.2.0/24,10.24.30.64/26,10.24.30.0/26,10.24.128.0/26,10.50.0.0/16,172.27.4.0/22,172.27.8.0/22,158.119.113.0/25,158.119.122.0/23,10.10.40.0/24,10.10.42.0/24"
        destination_address_prefix = "10.24.16.0/22"
      ...
      },
      {
        ...
        protocol                   = "Tcp"
        source_port_range          = "*"
        destination_port_range     = "443, 3443, 5671, 5672"
        source_address_prefix      = "10.24.16.0/22"
        destination_address_prefix = "10.24.16.0/22"
      ...
      },
      {
        ...
        source_address_prefix      = "10.24.30.64/26,10.24.30.0/26"
        destination_address_prefix = "10.24.16.0/22"
      ...
      },
      {
        ...
        source_address_prefix      = "10.24.20.16/32"
        destination_address_prefix = "10.24.16.20"
      ...
      },
      {
        ...
        source_address_prefix      = "10.16.20.137,10.24.16.5"
        destination_address_prefix = "10.24.16.0/22"
        description                = "Allow Inbound Access to from eCTD Azure Storage Account/Containers stmhradevuksla03 stmhrasituksrms03"
      },
      {
        ...
        source_address_prefix      = "10.16.20.137,10.24.16.5,10.24.16.20,10.20.0.0/22,10.20.4.0/22,192.168.208.0/21,172.27.4.0/22,172.27.8.0/22,158.119.113.0/25,158.119.122.0/23,10.10.40.0/24,10.10.42.0/24"
        destination_address_prefix = "*"
      ...
      },
      {
        ...
        source_port_range          = "*"
        destination_port_range     = "*"
        source_address_prefix      = "10.24.16.34"
        destination_address_prefix = "10.24.20.135"
      ...
      },
      {
        ...
        source_address_prefix      = "10.24.16.8,10.24.16.10"
      ...
      },
      {
        ...
        source_address_prefix      = "10.24.0.0/16"
        destination_address_prefix = "10.2.22.31"
        description                = "Allow SMTP connection outbound from SIT services for email notifications"
      },
      {
        ...
        source_port_range          = "*"
        destination_port_range     = "1433"
        source_address_prefix      = "10.16.20.13,10.24.20.16"
        destination_address_prefix = "10.2.22.31"
      ...
      },
      {
        ...
        destination_port_range     = "445,139"
        source_address_prefix      = "10.24.16.0/22"
        destination_address_prefix = "10.16.20.137,10.24.16.5"
      ...
      },
      {
        ...
        source_address_prefix      = "*"
        destination_address_prefix = "10.5.255.37,10.24.16.5"
  ...
  nsg-snet-mhra-sit-uks-h1s01-data = {
    provider_alias      = "spoke1-sub"
    is_applicable       = true
    resource_group_name = "rg-mhra-sit-uks-network"
    tags = {
    ...
    security_rule = [
      {
        ...
        destination_port_range     = "22,443,3389"
        source_address_prefix      = "10.20.0.0/22,10.20.4.0/22,10.100.0.82,10.100.0.113"
        destination_address_prefix = "10.24.20.0/22"
        description                = "Allows access from on-premises VDI"
      },
      {
        name                       = "Allow_DCS_SIT"
        ...
        destination_port_range     = "443"
        source_address_prefix      = "10.2.22.162"
        destination_address_prefix = "10.24.20.134,10.24.20.135"
        description                = ""
      },
      {
        ...
        source_address_prefix      = "10.24.16.0/22,10.24.30.64/26,10.24.30.0/26"
        destination_address_prefix = "10.24.20.0/22"
      ...
      },
      {
        ...
        source_port_range          = "*"
        destination_port_range     = "135, 139, 445, 636, 1688, 3268, 6269, 49152-65535"
        source_address_prefix      = "172.27.13.12,10.7.50.12,10.5.50.11,10.5.88.11,172.27.13.11,10.5.50.12,10.7.50.11,10.5.88.10"
        destination_address_prefix = "10.24.20.0/22"
        description                = "Allow AD services inbound"
      },
      {
      ...
      },
      {
        ...
        source_port_range          = "*"
        destination_port_range     = "443"
        source_address_prefix      = "10.5.1.0/24,10.20.0.0/22,10.20.4.0/22,10.5.2.0/24,10.24.30.64/26,10.24.30.0/26,10.24.128.0/26"
        destination_address_prefix = "10.24.20.0/22"
      ...
      },
      {
        ...
        source_address_prefix      = "10.24.20.0/22"
        destination_address_prefix = "10.24.20.0/22"
        description                = "Allow Intra Subnet inbound"
      },
      {
        ...
        source_port_range          = "*"
        destination_port_range     = "1433"
        source_address_prefix      = "10.5.240.0/24,10.5.1.0/24,10.20.0.0/22,10.20.4.0/22,10.5.2.0/24,10.100.0.113,10.100.0.82"
        destination_address_prefix = "10.24.20.0/22"
      ...
      },
      {
        ...
        source_address_prefix      = "10.24.16.20"
        destination_address_prefix = "10.16.20.137,10.24.16.5"
        description                = "allow Lorenz ECTD storage account to vmectd01situks"
      },
      {
        ...
        destination_address_prefix = "10.24.20.133"
      ...
      },
      {
        ...
        destination_address_prefix = "10.24.20.135"
        description                = "allow_MoveIT_Auto_Inbound  to stmhrasitla02 storage account"
      },
      {
        ...
        source_address_prefix      = "10.24.129.0/26"
        destination_address_prefix = "10.24.20.0/22"
      ...
      },
      {
        ...
        source_address_prefix      = "10.24.20.133"
      ...
      },
      {
        ...
        source_address_prefix      = "10.16.20.137,10.24.16.5"
        destination_address_prefix = "10.24.16.20"
        description                = "Allow Outbound from Lorenz VM  vmectd01 situks to eCTD Dossier Azure Storage Account"
      },
      {
      ...
      },
      {
        ...
        source_address_prefix      = "10.24.20.0/22"
        destination_address_prefix = "10.24.16.0/22,10.24.30.64/26,10.24.30.0/26"
        description                = "Allow App subnet outoutbound"
      },
      {
        name                       = "Allow_Outbound_Vmla01situks_to_Apian"
        priority                   = 1850
        direction                  = "Outbound"
        access                     = "Allow"
        protocol                   = "*"
  ...
  nsg-snet-mhra-sit-uks-h1s01-lgappsubnet = {
    provider_alias      = "spoke1-sub"
    is_applicable       = true
    resource_group_name = "rg-mhra-sit-uks-network"
    tags = {
  ...
  nsg-snet-mhra-sit-uks-h1s01-azfuncsubnet = {
    provider_alias      = "spoke1-sub"
    is_applicable       = true
    resource_group_name = "rg-mhra-sit-uks-network"
    tags = {
  ...
  nsg-snet-mhra-sit-uks-h1s01-appservicessubnet = {
    provider_alias      = "spoke1-sub"
    is_applicable       = true
    resource_group_name = "rg-mhra-sit-uks-network"
    tags = {
...
nsg-snet-mhra-sit-uks-h1s01-apimsubnet = {
    provider_alias      = "spoke1-sub"
    is_applicable       = true
    resource_group_name = "rg-mhra-sit-uks-network"
    tags = {
    ...
    security_rule = [
      {
        ...
        source_port_range          = "*"
        destination_port_range     = "443"
        source_address_prefix      = "10.24.10.0/24,10.24.16.0/22,10.24.128.0/26"
        destination_address_prefix = "10.24.128.128/29"
        description                = "Allow HTTPS Inbound"
      },
      {
      ...
      },
      {
        ...
        source_port_range          = "*"
        destination_port_range     = "80,443"
        source_address_prefix      = "10.24.128.128/29"
        destination_address_prefix = "*"
...
nsg_subnet_association_config = [{
  ...
  network_security_group_name = "nsg-snet-mhra-sit-uks-h1s01-waf"
  },
  {
    provider_alias              = "spoke1-sub"
    is_applicable               = true
    ...
    network_security_group_name = "nsg-snet-mhra-sit-uks-h1s01-presentation"
  },
  {
    provider_alias              = "spoke1-sub"
    is_applicable               = true
    ...
    network_security_group_name = "nsg-snet-mhra-sit-uks-h1s01-app"
  },
  {
    provider_alias              = "spoke1-sub"
    is_applicable               = true
    ...
    network_security_group_name = "nsg-snet-mhra-sit-uks-h1s01-data"
  },
  {
    provider_alias              = "spoke1-sub"
    is_applicable               = true
    ...
    network_security_group_name = "nsg-snet-mhra-sit-uks-h1s01-lgappsubnet"
  },
  {
    provider_alias              = "spoke1-sub"
    is_applicable               = true
    ...
    network_security_group_name = "nsg-snet-mhra-sit-uks-h1s01-azfuncsubnet"
  },
  {
    provider_alias              = "spoke1-sub"
    is_applicable               = true
    ...
    network_security_group_name = "nsg-snet-mhra-sit-uks-h1s01-appservicessubnet"
  }
]