...
*/
  ...
  mondiag-mhra-mgmt-uks-pip-001 = {
    ...
    target_resource_name           = "pip-agw-mhra-prod-uks-h1s01"
  ...
  mondiag-mhra-mgmt-uks-agw-001 = {
    ...
    target_resource_name           = "agw-mhra-prod-uks-01"
    target_resource_subresource    = ""
    storage_account_name           = "stmhracnctuksvmdiag01"
    target_resource_id             = ""
    log_analytics_workspace_name   = "lw-mhra-mgmt-uks-01"
  ...
  mondiag-mhra-mgmt-uks-appi-001 = {
    ...
    target_resource_name           = "appi-mhra-prod-uks-001"
    target_resource_subresource    = ""
    storage_account_name           = "stmhracnctuksvmdiag01"
    target_resource_id             = ""
    log_analytics_workspace_name   = "lw-mhra-mgmt-uks-01"
...
app_insights_config = {
  appi-mhra-prod-uks-001 = {
    provider_alias                              = "spoke1-sub"
    is_applicable                               = true
    resource_group_name                         = "rg-mhra-prod-uks-monitoring"
    log_analytics_workspace_name                = "lw-mhra-mgmt-uks-01"
