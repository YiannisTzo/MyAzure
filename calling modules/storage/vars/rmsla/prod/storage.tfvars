...
storage_account_config = {
  stmhraproduksrms01 = {
    ...
    network_rules = {
      ...
      whitelist_public_ips_or_cidrs = ["116.193.130.246"]
  ...
  stmhraproduksrms02 = {
    ...
    network_rules = {
      enforce_network_rules         = true # set to false if you want the keyvault to allow all traffic.
      whitelist_public_ips_or_cidrs = ["18.135.112.100", "18.135.112.128", "18.135.112.181", "35.177.153.88", "52.56.57.70", "52.56.95.43", "54.170.239.72", "54.228.31.150", "54.229.32.187", "54.229.33.30", "54.229.33.31", "54.247.146.71", "20.108.192.228"]
      bypass_traffic                = ["AzureServices"]
      subnets_config = {
      }
  ...
  stmhraproduksrms03 = {
    ...
    azure_files_authentication = {
     ...
     active_directory = {
      ...
      storage_sid         = "S-1-5-21-955253713-2270966224-1425722354-23663"
