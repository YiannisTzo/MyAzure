...
vm_network_interface_config = {
  vmla01situks-nic01 = {
    ...
    ip_configuration = {
      ...
      subnet_id                     = "snet-mhra-sit-uks-h1s01-data"
      private_ip_address_allocation = "Static"
      private_ip_address            = "10.24.20.133"
    }
...
vm_config = {
  vmla01situks = {
    ...
    network_interface_ids = ["vmla01situks-nic01"]
    os_disk = {
      caching              = "ReadWrite"
      storage_account_type = "Standard_LRS"
      name                 = ""
...
managed_disk_attachment_config = {
  disk-attachment-zone1-001 = {
    provider_alias       = "spoke1-sub"
    is_applicable        = true
    managed_disk_name    = "vmla01situks-data01"
    virtual_machine_name = "vmla01situks"
    lun                  = "10"
    caching              = "None"
...
azurerm_recovery_services_vault_config = {
  rs01situks = {
    ...
    resource_group_name = "rg-mhra-sit-uks-backup"
    sku                 = "Standard"
...
azurerm_backup_policy_vm_config = {
  bkpiaasmhrasituks-d14w0-2000 = {
    ...
    resource_group_name = "rg-mhra-sit-uks-backup"
    recovery_vault_name = "rs01situks"
    timezone            = "UTC"
    backup = {
      frequency = "Daily"
      time      = "20:00"
...
azurerm_backup_protected_vm_config = {
  backup-protected-vm-001-sit = {
    provider_alias      = "spoke1-sub"
    is_applicable       = true
    resource_group_name = "rg-mhra-sit-uks-backup"
    recovery_vault_name = "rs01situks"
    source_vm_name      = "vmla01situks"
    backup_policy_name  = "bkpiaasmhrasituks-d14w0-2000"
    exclude_disk_luns   = []
    include_disk_luns   = []
  }
}
...
resource_role_config = [{
  is_applicable                    = true
  resource_name                    = "rg-mhra-sit-uks-network"
  resource_type                    = "resource-group"
  resource_provider                = "spoke1"
  role                             = "contributor"
  principal_provider_resource_name = "rs01situks"
